...
const (
	...
	NokiaSrl = "nokia_srl"
	// ArubaWlc is a constant representing the platform string/name for Aruba Wireless controller AOS devices.
	ArubaWlc = "aruba_wlc"
	...
	// Ruijie is a constant representing the platform string/name for Ruijie network devices.
	RuijieOs = "ruijie_os"
	// // FortinetFortiOs is a constant representing the platform string/name for Fortinet firewall devices.
...
func GetPlatformNames() []string {
	return []string{
		AristaEos, CiscoIosxe, CiscoIosxr, CiscoNxos, JuniperJunos, NokiaSrl, ArubaWlc, HpComware, HuaweiVrp, RuijieOs,
	}
}

...
// devices change their prompt to indicate adding entries to lists or something similar. For
// example, when editing `trace-options` on nokia srl devices with scrapli(go) the prompt changes
